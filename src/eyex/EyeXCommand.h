 ...
 */
TX_API_FUNCTION(CreateCommand,(
    TX_CONTEXTHANDLE hContext,
    TX_OUT_PARAM(TX_HANDLE) phCommand,
...
/**
  ...
  @return 
    ...
    TX_RESULT_INVALIDARGUMENT: An invalid argument was passed to the function.
 */
TX_API_FUNCTION(GetCommandType,(
    TX_CONSTHANDLE hCommand,
    TX_OUT_PARAM(TX_INTERACTIONCOMMANDTYPE) pCommandType
    ));
...
/**
  ...
  @return 
    ...
    TX_RESULT_INVALIDARGUMENT: An invalid argument was passed to the function.
 */
TX_API_FUNCTION(SetCommandData,(
    TX_HANDLE hCommand,
    TX_HANDLE hObject
    ));
 ...
 */
TX_API_FUNCTION(GetCommandData,(
    TX_CONSTHANDLE hCommand,
...
/**
  ...
  @return 
    ...
    TX_RESULT_INVALIDARGUMENT: An invalid argument was passed to the function.
 */
TX_API_FUNCTION(ExecuteCommandAsync,(
    TX_HANDLE hCommand,
