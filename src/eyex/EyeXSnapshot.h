...
*/
TX_API_FUNCTION(CreateSnapshot,(
    TX_CONTEXTHANDLE hContext, 
    TX_OUT_PARAM(TX_HANDLE) phSnapshot 
    ));
...
/**
  ...
  @return 
    ...
    TX_RESULT_INVALIDARGUMENT: An invalid argument was passed to the function.    
*/
TX_API_FUNCTION(CreateSnapshotWithQueryBounds,(
...
/**
  ...
  @return 
    ...
    TX_RESULT_INVALIDARGUMENT: An invalid argument was passed to the function.    
*/
TX_API_FUNCTION(CreateSnapshotForQuery,(
    TX_CONSTHANDLE hQuery,
    TX_OUT_PARAM(TX_HANDLE) phSnapshot 
    ));
...
/**
  ...
  @return 
    ...
    TX_RESULT_INVALIDARGUMENT: An invalid argument was passed to the function.
*/
TX_API_FUNCTION(CommitSnapshotAsync,(
    TX_HANDLE hSnapshot, 
...
*/
TX_API_FUNCTION(GetSnapshotBounds,(
...
/**
  ...
  @return 
    ...
    TX_RESULT_INVALIDARGUMENT: An invalid argument was passed to the function.
*/
TX_API_FUNCTION(GetSnapshotWindowIdCount,(
    TX_CONSTHANDLE hSnapshot,
...
*/
TX_API_FUNCTION(GetSnapshotWindowId,(
    TX_CONSTHANDLE hSnapshot,
...
/**
  ...
  @return 
    ...
    TX_RESULT_INVALIDARGUMENT: An invalid argument was passed to the function.
*/
TX_API_FUNCTION(AddSnapshotWindowId,(
    TX_HANDLE hSnapshot, 
...
*/
TX_API_FUNCTION(CreateInteractor,(
    TX_HANDLE hSnapshot,
    TX_OUT_PARAM(TX_HANDLE) phInteractor,
...
/**
  ...
  @return 
    ...
    TX_RESULT_DUPLICATEINTERACTOR: An interactor with the same id already exists in this snapshot.
*/
TX_API_FUNCTION(CreateRectangularInteractor,(
    TX_HANDLE hSnapshot,    
    TX_OUT_PARAM(TX_HANDLE) phInteractor,
    TX_CONSTSTRING interactorId,
    TX_REF_PARAM(TX_RECT) pBounds,
    TX_CONSTSTRING parentId,
    TX_CONSTSTRING windowId
    ));
 ...
 */
TX_API_FUNCTION(RemoveInteractor,(
    TX_HANDLE hSnapshot,
    TX_CONSTSTRING interactorId
    ));
 ...
 */
TX_API_FUNCTION(GetInteractors,(
    TX_CONSTHANDLE hSnapshot,    
    TX_PTR_PARAM(TX_HANDLE) phInteractors,
    TX_REF_PARAM(TX_SIZE) pInteractorsSize
    ));
...
*/
TX_API_FUNCTION(CreateSnapshotBounds,(
    TX_HANDLE hSnapshot,
    TX_OUT_PARAM(TX_HANDLE) phBounds,
...
/**
  ...
  @return 
    ...
    TX_RESULT_NOTFOUND: The snapshot does not have any bounds.
*/
TX_API_FUNCTION(DeleteSnapshotBounds,(
    TX_HANDLE hSnapshot
    ));
...
/**
  ...
  @return 
    ...
    TX_RESULT_INVALIDARGUMENT: An invalid argument was passed to the function.    
 */ 
TX_API_FUNCTION(CreateGlobalInteractorSnapshot, (
    TX_CONTEXTHANDLE hContext, 
    TX_CONSTSTRING interactorId, 
    TX_OUT_PARAM(TX_HANDLE) hSnapshot, 
    TX_OUT_PARAM(TX_HANDLE) hInteractor
    ));
